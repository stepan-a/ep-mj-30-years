...
for i=1:maxorder
    [s(i), N(i)] = sparsity_with_sparse_tree(m, p(i), H, n);
end
...
matlab2tikz('../../tex/plots/sparse-stacked-jacobian-3-nodes-sparse-tree.tikz')
...
matlab2tikz('../../tex/plots/sparse-stacked-jacobian-5-nodes-sparse-tree.tikz')
...
matlab2tikz('../../tex/plots/sparse-stacked-jacobian-7-nodes-sparse-tree.tikz')
...
matlab2tikz('../../tex/plots/sparse-stacked-jacobian-11-nodes-sparse-tree.tikz')
